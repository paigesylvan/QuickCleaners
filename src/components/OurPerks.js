...
const ScrollRevealBoxes = () => {
  ...
  return (
    <section className="bg-gray-100 flex flex-col items-center justify-center px-6 pb-10 lg:mb-5 overflow-hidden">
      <h1 className='text-5xl font-bold text-center lg:text-7xl overflow-hidden py-12 lg:py-16 font-roboto '>Our Perks</h1>
