...
const ScrollRevealBoxes = () => {
  ...
  return (
    <section className="bg-black flex flex-col items-center justify-center px-6 pb-10 lg:mb-12 overflow-hidden">
      <h1 className='text-white text-5xl font-bold text-center lg:text-7xl overflow-hidden py-12 lg:py-16 '>Our Perks</h1>
