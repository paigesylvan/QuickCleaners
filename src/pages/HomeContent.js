...
return (
  <div className="homepage">
    ...
    <section className='flex flex-col items-center mb-16 lg:mb-[80px] mt-4' >
      <img src={storyimg} className=' hidden lg:block px-36' alt='owner-image'></img>
      <img src={storyimg2} className='block lg:hidden p-6' alt='owner-image-single' ></img>
        <div className='flex flex-col items-center justify-center  '>
          ...
          <h2 className="text-md  mt-8  lg:text-3xl overflow-hidden "> - Sandy & staff at Quick Cleaners & Laundry</h2>
        </div>
    </section>
