    ...
    const FloatingTextBoxes = () => {
        ...
        useEffect(() => {
            const handleScroll = () => {
                ...
                const offsets = [400, 800, 1000, 1300]
                    setIsVisible([
        ...
        return (
            <div className="floating-text-boxes-container">
              ...
              <div className={`floating-text-box ${isVisible[1] ? 'visible' : ''}`}>
                <img src={PNG} alt="Left Image" className="side-image" /> 
                <h1 style={{color:'#610015'}}>All Work Done on Premise</h1>
    ...
    <div className="home-section">
        <div style={{position: 'relative'}}>
            ...
            <div className="video-overlay-text">
                ...
                <h2> 2177 Silvernail Rd, Pewaukee, WI</h2>
                <p></p>
                <a href="/services">
        ...
        <div className='family-owned'>
            ...
            <div className="bottom-section">
               <div className="bottom-text">
                  <h1>We Honor ALL Competitor Coupons</h1>
                  <h1>All Work Done on Premise</h1>
